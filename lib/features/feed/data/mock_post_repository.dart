...
class MockPostRepository implements PostRepository{
  ...
  Future<List<PostEntity>> fetchPosts() async {
    return [
      ...
      PostEntity(userId: '12', username: 'RAm', content: 'Science Tech', createdAt: DateTime.now()),
      PostEntity(userId: '12', username: 'Ha', content: 'Science Tech', createdAt: DateTime.now()),
      PostEntity(userId: '12', username: 'TR', content: 'Science Tech', createdAt: DateTime.now()),
    ];
  }
}
